...
[![Portfolio](https://img.shields.io/badge/Portfolio-Gameboy%20Style?style=for-the-badge&color=355C3B)](https://vrushal.vercel.app)
...
```
[████████████] 100% COMPLETE
> Designed autonomous task routing
> 801× query speedup via semantic caching
> 4.8× faster responses through prompt compression
> 92% cache hit rate
```
...
```
[████████████] 100% COMPLETE
> Benchmarked 9 ML classifiers on Twitter data
> Bagging Classifier: 92.92% accuracy, 94.5% F1
> Deployed real-time detection web app
...
┌─────────────────────────────────────────────────────────────────┐
│  📖 Published in Springer LNNS, ICTIS 2024 (Scopus-indexed)     │
│  🎓 Patent granted for innovative video surveillance system     │
│  🥈 Runner-Up at HackMITWPU'24 (Maha-Metro video analytics)    │
│  🎯 9.06 CGPA at Vishwakarma Institute of Technology           │
└─────────────────────────────────────────────────────────────────┘
```
...
![Vrushal's GitHub Stats](https://github-readme-stats.vercel.app/api?username=itsVrushal&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0,355C3B,4A7C59&title_color=6B8E6B&text_color=C5D5C5)
...
<p align="center">
<a href="https://linkedin.com/in/vrushal-patil">
